...
void main() { // Define the main function, the starting point of the program.
  ...
  print("5. Modulus (%)"); //Display modulus
  ...
  switch (choice) { // Begin a switch statement based on the user's choice.
    ...
    case 5: // Case 5: Modulus
      if (num2 != 0) { // Check if the denominator is not zero
         result = num1 % num2; // Perform modulus operation
         print("Result: $num1 % $num2 = $result"); // Display the modulus result
      } 
      break; // Exit the switch statement
  }
}